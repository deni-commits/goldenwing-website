...
export const Posts: CollectionConfig = {
  ...
  fields: [
    ...
    // ============================================================
    {
      ...
      type: 'text',
      label: 'Autor-Qualifikation für diesen Artikel',
      localized: true,
      admin: {
        description: 'Z.B. "10 Jahre SEO Erfahrung, Google Certified" - wird unter dem Autorennamen angezeigt',
      },
    },
    {
      name: 'lastReviewedAt',
      ...
      admin: {
        position: 'sidebar',
        description: 'Wann wurde der Inhalt zuletzt auf Aktualität geprüft?',
        date: {
    ...
    },
    {
      ...
      relationTo: 'team-members',
      admin: {
        description: 'Team-Mitglied das den Inhalt auf Richtigkeit geprüft hat',
      },
    },
    {
      name: 'contentRating',
      type: 'group',
      label: 'Inhalts-Bewertung',
      admin: {
        description: 'Für Schema.org AggregateRating',
      },
      fields: [
        {
          name: 'averageRating',
