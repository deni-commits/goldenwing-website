...
// Certificate Badge SVG Component
const CertificateBadge = () => (
  <svg
    className="fill-primary -mt-12 h-18 w-full overflow-hidden"
    width="24"
    height="24"
    viewBox="0 0 24 24"
  >
...
// Award Badge SVG Component
const AwardBadgeSvg = () => (
  <svg
    className="fill-primary h-full w-18 overflow-hidden"
    width="500.15"
    height="620.78"
...
export function Awards({
  ...
  // Stamp Variant
  if (variant === "stamp") {
    // Pre-calculated serrated path to avoid hydration mismatch
    // (Math.cos/sin can have floating-point precision differences between server/client)
    const serratedPath = "M 192 96 L 182.917 109.766 L 187.301 125.666 L 174.014 136.128 L 174.014 152.666 L 158.209 158.209 L 152.666 174.014 L 136.128 174.014 L 125.666 187.301 L 109.766 182.917 L 96 192 L 82.234 182.917 L 66.334 187.301 L 55.872 174.014 L 39.334 174.014 L 33.791 158.209 L 17.986 152.666 L 17.986 136.128 L 4.699 125.666 L 9.083 109.766 L 0 96 L 9.083 82.234 L 4.699 66.334 L 17.986 55.872 L 17.986 39.334 L 33.791 33.791 L 39.334 17.986 L 55.872 17.986 L 66.334 4.699 L 82.234 9.083 L 96 0 L 109.766 9.083 L 125.666 4.699 L 136.128 17.986 L 152.666 17.986 L 158.209 33.791 L 174.014 39.334 L 174.014 55.872 L 187.301 66.334 L 182.917 82.234 Z"
