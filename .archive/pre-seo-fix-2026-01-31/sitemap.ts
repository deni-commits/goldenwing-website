...
const pathTranslations: Record<string, string> = {
  ...
  '/abu-dhabi': '/abu-dhabi',
  '/sharjah': '/sharjah',
  '/dubai/web-design-company-dubai': '/dubai/web-design-company-dubai',
  '/dubai/seo-company-dubai': '/dubai/seo-company-dubai',
  '/dubai/branding-agency-dubai': '/dubai/branding-agency-dubai',
  '/dubai/digital-marketing-agency-dubai': '/dubai/digital-marketing-agency-dubai',
  '/dubai/ecommerce-development-dubai': '/dubai/ecommerce-development-dubai',
  '/abu-dhabi/web-design-abu-dhabi': '/abu-dhabi/web-design-abu-dhabi',
  '/abu-dhabi/seo-abu-dhabi': '/abu-dhabi/seo-abu-dhabi',
  '/abu-dhabi/branding-abu-dhabi': '/abu-dhabi/branding-abu-dhabi',
  ...
  '/sharjah/web-design-sharjah': '/sharjah/web-design-sharjah',
  '/sharjah/seo-sharjah': '/sharjah/seo-sharjah',
  '/sharjah/branding-sharjah': '/sharjah/branding-sharjah',
  '/sharjah/digital-marketing-sharjah': '/sharjah/digital-marketing-sharjah',
  '/sharjah/ecommerce-sharjah': '/sharjah/ecommerce-sharjah',
  '/web-design-abu-dhabi': '/web-design-abu-dhabi',
...
const staticRoutes = [
  ...
  // Location pages - Trust signals (physical presence)
  { path: '/standorte', priority: 0.8, changeFrequency: 'monthly' as const }, // Pillar page
  { path: '/standorte/wien', priority: 0.75, changeFrequency: 'monthly' as const },
  { path: '/standorte/dubai', priority: 0.7, changeFrequency: 'monthly' as const },
  ...
  { path: '/web-design-abu-dhabi', priority: 0.75, changeFrequency: 'monthly' as const },

  // UAE Hub Pages & Location Services
  { path: '/uae', priority: 0.8, changeFrequency: 'monthly' as const },
  ...
  // Dubai services (English)
  { path: '/dubai/web-design-company-dubai', priority: 0.85, changeFrequency: 'monthly' as const },
  { path: '/dubai/seo-company-dubai', priority: 0.85, changeFrequency: 'monthly' as const },
  { path: '/dubai/branding-agency-dubai', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/dubai/digital-marketing-agency-dubai', priority: 0.85, changeFrequency: 'monthly' as const },
  { path: '/dubai/ecommerce-development-dubai', priority: 0.8, changeFrequency: 'monthly' as const },
  // Abu Dhabi services
  { path: '/abu-dhabi/web-design-abu-dhabi', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/abu-dhabi/seo-abu-dhabi', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/abu-dhabi/branding-abu-dhabi', priority: 0.75, changeFrequency: 'monthly' as const },
  ...
  // Sharjah services
  { path: '/sharjah/web-design-sharjah', priority: 0.75, changeFrequency: 'monthly' as const },
  { path: '/sharjah/seo-sharjah', priority: 0.75, changeFrequency: 'monthly' as const },
  { path: '/sharjah/branding-sharjah', priority: 0.7, changeFrequency: 'monthly' as const },
  ...
  { path: '/leistungen/wordpress-agentur', priority: 0.75, changeFrequency: 'monthly' as const },
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  try {
    ...
    for (const subService of subServices.docs) {
      if (subService.slug && subService.parentService) {
        ...
        if (parentSlug) {
          ...
          if (!enSubSlug) {
            console.warn(`[SITEMAP] Missing EN translation for subservice slug: ${subService.slug} - skipping URL`)
    ...
    // Add DE blog posts with correct alternates
